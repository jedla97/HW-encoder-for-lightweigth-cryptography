...
proc create_root_design { parentCell } {
  ...
  set btn0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 btn0 ]
  ...
  # Create instance: LBlock_wrapper, and set properties
  set LBlock_wrapper [ create_bd_cell -type ip -vlnv xilinx.com:user:LBlock_wrapper:4.0 LBlock_wrapper ]

  # Create instance: LFSR32bit, and set properties
  set block_name LFSR32bit
  set block_cell_name LFSR32bit
  if { [catch {set LFSR32bit [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.1} \
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {0.1} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports btn0] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins LBlock_wrapper/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net LFSR32bit_0_random_data_out [get_bd_pins LFSR32bit/random_data_out] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LBlock_wrapper/s00_axi_aclk] [get_bd_pins LFSR32bit/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins LBlock_wrapper/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LBlock_wrapper/S00_AXI/S00_AXI_reg] -force
